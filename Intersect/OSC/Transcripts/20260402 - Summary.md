...
| Bituagie Dashboard         | Current hosting is ending. Intersect is working to host the dashboard internally and integrate reporting via CryptoEQ.                                             | The transition is in progress to ensure data continuity.                                                                                                           |
